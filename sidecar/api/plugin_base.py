...
from typing import Dict, Any, TYPE_CHECKING, cast, Callable, Awaitable
...
class PluginBase(ABC):
    ...
    def __init__(
        self, plugin_dir: Path, vault_path: Path, config: Dict[str, Any] = None
    ):
        """
        Initialize plugin.
    ...
    def progress(self, percentage: int, message: str = "") -> None:
        ...
        self.brain.emit_to_frontend(
            constants.EventType.PROGRESS, {"percentage": percentage, "message": message}
        )
    ...
    def load_settings(
        self, filename: str = constants.PLUGIN_SETTINGS_FILE
    ) -> Dict[str, Any]:
    ...
    def save_settings(
        self, settings: Dict[str, Any], filename: str = constants.PLUGIN_SETTINGS_FILE
    ) -> bool:
    ...
    async def register_sidebar_view(
        self, identifier: str, icon_svg: str, title: str
    ) -> None:
        """
    ...
    async def set_sidebar_content(self, identifier: str, html_content: str) -> None:
        """
        ...
        """
        self._emit_ui_command(
            constants.UIAction.SET_SIDEBAR, {"id": identifier, "html": html_content}
        )

    # --- Panel/Tab Management (GoldenLayout) ---

    async def register_panel(
        self, panel_id: str, title: str, icon: str = None, position: str = "right"
    ) -> None:
        """
    ...
    async def set_panel_content(self, panel_id: str, html_content: str) -> None:
        """
        ...
        """
        self._emit_ui_command(
            constants.UIAction.SET_PANEL, {"id": panel_id, "html": html_content}
        )
    ...
    async def remove_panel(self, panel_id: str) -> None:
        ...
        """
        self._emit_ui_command(constants.UIAction.REMOVE_PANEL, {"id": panel_id})

    # --- Toolbar Buttons ---

    async def register_toolbar_button(
        self, button_id: str, icon: str, title: str, command: str
    ) -> None:
        """
    ...
    async def set_toolbox_content(self, html_content: str) -> None:
        ...
        Args:
            html_content: HTML string to display
        """
        self._emit_ui_command(constants.UIAction.SET_TOOLBOX, {"html": html_content})
    ...
    async def add_toolbox_item(self, html_content: str) -> None:
        ...
        """
        self._emit_ui_command(
            constants.UIAction.ADD_TOOLBOX_ITEM, {"html": html_content}
        )
    ...
    async def show_modal(
        self, title: str, html_content: str, width: str = "500px"
    ) -> None:
        """
        Show a modal dialog.
    ...
    async def close_modal(self) -> None:
        ...
        self._emit_ui_command(constants.UIAction.CLOSE_MODAL, {})
