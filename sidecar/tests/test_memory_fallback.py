...
async def test_memory_fallback_linear_chat():
    ...
    with patch("sidecar.vault_brain.LLMService") as MockServiceClass:
        ...
        mock_instance.complete.return_value = MagicMock(content="Linear Response", model="test", usage={})
        ...
        mock_instance.complete.return_value = MagicMock(content="Second Response", model="test", usage={})
