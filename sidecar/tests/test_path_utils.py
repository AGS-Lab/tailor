...
class TestSafePathJoin:
    ...
    def test_prevent_directory_traversal_dotdot(self, tmp_path):
        ...
        with pytest.raises(exceptions.PathTraversalError):
            utils.safe_path_join(base, "..", "secret.txt")
...
class TestDiscoverPlugins:
    ...
    def test_discover_plugins_empty_directory(self, tmp_path):
        ...
        result = utils.discover_plugins(tmp_path)
        assert result == []
    ...
    def test_nonexistent_plugins_directory(self):
        ...
        result = utils.discover_plugins(fake_dir)
        assert result == []
